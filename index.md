...
The package supports at least three ways of specifying the model that should be
analyzed. The standard method for purely Gaussian models is to specify the
