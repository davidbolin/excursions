...
#'
#' @export
#' @param x An object generated by a call to \code{fm_mesh_2d} or
#'   \code{fm_rcdt_2d}, a triangle-vertex index matrix, or a list
...
#'   \item{contour}{A list of \code{sp} or \code{fm_segm} objects
#'     defining countour curves (level sets)}
#'   \item{map}{A list of \code{sp} or \code{fm_segm} objects
...
#'   are \code{"sp"} (default) and \code{"fm"} (and deprecated
#'   \code{"inla.mesh.segment"}, converted to \code{"fm"}).
...
#' \item{M}{\code{SpatialPolygons} or \code{fm_segm} object. The subsets
